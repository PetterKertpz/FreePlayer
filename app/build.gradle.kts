...
configure<ApplicationExtension> {
	namespace = "com.pmk.freeplayer"
	compileSdk = 36

   defaultConfig {
      applicationId = "com.pmk.freeplayer"
      ...
      buildConfigField(
         "String",
         "GENIUS_TOKEN",
         "\"${project.findProperty("GENIUS_TOKEN") ?: ""}\"",
      )
   ...
   lint {
      ...
      baseline = file("lint-baseline.xml") // Opcional: para trackear issues conocidos
   }
...
dependencies {
   ...
   // ========================================
   // COMPOSE UI - BOM para versiones consistentes
   // ========================================
   ...
   implementation(libs.jsoup) // Scraping de letras
