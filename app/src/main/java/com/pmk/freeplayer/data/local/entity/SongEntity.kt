...
@Entity(
	...
	foreignKeys = [
		ForeignKey(
			...
			onDelete = ForeignKey.SET_NULL // Si borras el artista, la canción queda "huérfana" (Unknown Artist)
		),
		ForeignKey(
...
data class SongEntity(
	...
	@ColumnInfo(name = "file_hash") val fileHash: String? = null, // Útil para detectar duplicados con distinto nombre
	...
	// "PENDING", "VERIFIED", "CORRECTED", "FAILED"
	@ColumnInfo(name = "metadata_status") val metadataStatus: String = "PENDING",
	@ColumnInfo(name = "confidence_score") val confidenceScore: Float = 0f // 0.0 - 1.0 (Confianza del match)
)